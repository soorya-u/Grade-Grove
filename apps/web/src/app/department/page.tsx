...
export default function () {
  return (
    <>
      <main className="flex flex-col items-center justify-center gap-8 before:content-[''] after:content-['']">
        ...
        <div className="flex flex-col items-start gap-3 px-4">
          <article className="text-center w-[90vw] text-lg">
            ...
            knowledge Acquisition, Processing, and Inference. AI defines the
            world by building Self-learning and Decision-making Machines
            learning through Experience. AI is to build simulations of Human
